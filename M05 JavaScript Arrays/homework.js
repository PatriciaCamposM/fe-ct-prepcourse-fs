...
function incrementarPorUno(array) {
   ...
   // }
   // return array;
   var arrayModificado = array.map((num) => {
      return num + 1;
   });
...
function cuentoElementos(array) {
   ...
   for (var i = 0; i < array.length; i++) {
      if (array[i] > 18) {
         retorArray.push(array[i]);
      }
   }
   return retorArray.length;
}
...
function empiezaConNueve(num) {
   ...
   // Tu código:
   // var comienzaNueve = (num) =>num.toString()[0]  === "9";
...
function mayorACien(array) {
   ...
   for (var i = 0; i < array.length; i++) {
      if (array[i] > 100) {
         hastaDoscientos.push(array[i]);
      }
   }
   return hastaDoscientos;
}
